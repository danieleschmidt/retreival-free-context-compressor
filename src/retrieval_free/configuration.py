...
class FeatureToggleManager:
    ...
    def is_enabled(self, toggle_name: str, user_id: Optional[str] = None, context: Optional[Dict[str, Any]] = None) -> bool:
    ...
    def get_toggle_status(self, name: str) -> Optional[Dict[str, Any]]:
    ...
    def _evaluate_ab_test(self, toggle_name: str, user_id: Optional[str], context: Optional[Dict[str, Any]]) -> bool:
...
_feature_toggle_manager: Optional[FeatureToggleManager] = None
