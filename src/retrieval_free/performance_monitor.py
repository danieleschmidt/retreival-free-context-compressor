...
class ResourceMonitor:
    ...
    def _collect_gpu_usage(self) -> Optional[Dict[str, float]]:
...
class PerformanceProfiler:
    ...
    def get_profile_results(self, operation_name: Optional[str] = None) -> List[Dict[str, Any]]:
...
class BottleneckDetector:
    ...
    def _analyze_cpu_bottleneck(self, time_window: float) -> Optional[BottleneckAnalysis]:
    ...
    def _analyze_memory_bottleneck(self, time_window: float) -> Optional[BottleneckAnalysis]:
    ...
    def _analyze_gpu_bottleneck(self, time_window: float) -> Optional[BottleneckAnalysis]:
    ...
    def _analyze_latency_bottleneck(self, time_window: float) -> Optional[BottleneckAnalysis]:
    ...
    def _analyze_queue_bottleneck(self, time_window: float) -> Optional[BottleneckAnalysis]:
...
@contextmanager
def performance_profile(operation_name: str, labels: Optional[Dict[str, str]] = None):
